...
public class IntTreeNode {
    ...
    public ArrayList<Integer> findValues(IntTreeNode root) {
    ...
    public void deleteValueAVL(IntTreeNode root, int data) {
        if (root != null) {
            if (root.left != null && root.left.data == data) {
                ...
                root.left = root.left.left;
                    ...
                    IntTreeNode temp = root.left.right;
                    root.left = root.left.left;
                    for (int i : temp.findValues(temp)) {
                        this.addValueAVL(i);
                    }
                }
                ...
                deleteValueAVL(root.right, data);
                deleteValueAVL(root.left, data);
            }
        }
        // update height
        refreshHeight();
