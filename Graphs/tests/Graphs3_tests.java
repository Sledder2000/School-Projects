...
public class Graphs3_tests extends TestsCore {
    ...
    public void test_partitionsCount() throws FileNotFoundException {
        ...
        assertEquals(5, g.countPartitions());
    }
    ...
    public void test_eulerianCircuit() throws FileNotFoundException {
        Graph<String> g = readGraph("/Graphs/data/basic8.txt");
        assertEquals(g.eulerianCircuit(), true);
        Graph<String> g2 = readGraph("/Graphs/data/complex1.txt");
        assertEquals(g2.eulerianCircuit(), false);
    }
    @Test
    public void test_eulerianPath() throws FileNotFoundException {
        Graph<String> g = readGraph("/Graphs/data/basic8.txt");
        ArrayList<Node<String>> a = g.eulerianPath("A");
